ADMIN_EMAIL = 'admin@algobasket.com'
...
if Rails.env == 'development'
  NORMAL_PASSWORD = 'developer'

  foo = Identity.create(email: 'developer@algobasket.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'developer2@algobasket.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
